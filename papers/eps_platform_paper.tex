...
The corpus includes 84 SPARC galaxies with the original Lelli et al.\ (2016) Q=1 quality flag (the ``golden sample'' used in Flynn \& Cannaliato 2025), identified by cross-referencing with the original SPARC Q=1 designations published in \citet{lelli2016}.
...
\item \textbf{High-z Examples} (25 notebooks): [CII] rotation curve analysis,
      ALPINE population statistics, Wisnioski et al.\ (2015; W15) disk criteria evaluation, cross-corpus
      omega bridge.
...
\item GC Corpus v1.3.1: \dataset[10.5281/zenodo.19907766]{https://doi.org/10.5281/zenodo.19907766}
\item High-z Corpus Z1: \dataset[10.5281/zenodo.20369286]{https://doi.org/10.5281/zenodo.20369286}
\end{itemize}
...
In accordance with standard practice for AI-assisted research,
the author discloses the following. Four large language models were
used during the creation and validation of this corpus and manuscript:
Google Gemini Pro, Anthropic Claude (Sonnet and Opus), Microsoft
Copilot Pro, and Gemma 4 31B Dense (self-hosted). Because the corpus
is explicitly designed for LLM-based RAG pipelines, these models served
as both development tools and validation instruments. All scientific
content, data analysis, corpus construction, and conclusions are the
