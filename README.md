...
|-------|----------|-------------|
| [SPARC / HI Examples](./examples/hi/) [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/eps-research/rag-corpus-series/blob/main/examples/hi/ex25_end_to_end_omega_workflow.ipynb) | 25 | Rotation curve plotting, baryonic decomposition, omega correction, WALLABY tier-2 analysis |
| [Dwarf / Irregular Examples](./examples/dwarfs/) [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/eps-research/rag-corpus-series/blob/main/examples/dwarfs/dw25_end_to_end_dwarf_workflow.ipynb) | 25 | Omega-ready galaxies, DDO154/DDO161 cross-analysis, LVHIS/VLA-ANGST comparisons |
| [Globular Cluster Examples](./examples/gc/) [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/eps-research/rag-corpus-series/blob/main/examples/gc/gc25_end_to_end_gc_query.ipynb) | 25 | Proper motion queries, N-body mass modeling, APOGEE chemistry, multi-survey cross-matching |
| [IntZ Examples](./examples/intz/) [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/eps-research/rag-corpus-series/blob/main/examples/intz/intz_nb20_end_to_end_workflow.ipynb) | 20 | KROSS/KMOS3D kinematics, omega distributions, cross-epoch comparisons, RAG queries |
| [High-z Examples](./examples/highz/) [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/eps-research/rag-corpus-series/blob/main/examples/highz/hz_nb25_end_to_end_workflow.ipynb) | 25 | [CII] rotation curves, ALPINE population statistics, cross-corpus omega bridge |
| [High-School Exploration Track](./examples/highschool/) [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/eps-research/rag-corpus-series/blob/main/examples/highschool/hs_b_10_capstone.ipynb) | 20 | Friendly introductory notebooks for students: what is a rotation curve? what is a galaxy? |
