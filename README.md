...
> |----------|-------|--------|
> **A unified open-science astrophysics platform combining five machine-readable corpora, 147 reproducible notebooks, and cross-epoch kinematic tools spanning z = 0 to z ~ 6.**
---
📄 Cite This Platform
...
> or clone the repo and run locally with JupyterLab. All 147 notebooks 
> execute correctly (verified 147/147 pass rate).
🚀 New here? Start with QuickStart.ipynb — Open in Colab — load all five corpora and reproduce the core omega sign reversal result in 10 minutes.
---
...
async def query():
    async with streamablehttp_client("https://dflynn5656-astro-rag-mcp.hf.space/mcp") as (r, w, _):
        async with ClientSession(r, w) as session:
            ...
            result = await session.call_tool("get_object",
                {"corpus": "v7", "object_id": "DDO161"})
            record = json.loads(result.content[0].text)["record"]
            print(record["galaxy"], record["distance_mpc"], "Mpc")

asyncio.run(query())
```
Hosted on Hugging Face Spaces (Docker, always-on). Serves 2,064 objects across all five corpora. Full test suite: 80/81 passing on live deployment.
---
...
Unified HI Rotation Curve Corpus v7.0	438 galaxies	HI 21cm	10.5281/zenodo.19563417	2604.13489
Dwarf/Irregular HI Corpus v1.0	129 galaxies	HI 21cm	10.5281/zenodo.20320362	2605.22163
Milky Way Globular Cluster Corpus v1.3.1	174 clusters	Multi-survey	10.5281/zenodo.19907766	2605.03099
...
IntZ Kinematic Corpus v1.0	1,292 galaxies	z = 0.38–2.68	Hα / [O III]	10.5281/zenodo.20453189	in prep
High-z Kinematic Corpus Z1	31 galaxies	z = 4.26–5.68	ALMA [CII] 158μm	10.5281/zenodo.20369286	2605.25339
...
SPARC / HI Examples ![Colab](https://colab.research.google.com/assets/colab-badge.svg) ![nbviewer](https://img.shields.io/badge/render-nbviewer-orange)	25	Rotation curve plotting, baryonic decomposition, omega correction, WALLABY tier-2 analysis
Dwarf / Irregular Examples ![Colab](https://colab.research.google.com/assets/colab-badge.svg) ![nbviewer](https://img.shields.io/badge/render-nbviewer-orange)	25	Omega-ready galaxies, DDO154/DDO161 cross-analysis, LVHIS/VLA-ANGST comparisons
Globular Cluster Examples ![Colab](https://colab.research.google.com/assets/colab-badge.svg) ![nbviewer](https://img.shields.io/badge/render-nbviewer-orange)	25	Proper motion queries, N-body mass modeling, APOGEE chemistry, multi-survey cross-matching
IntZ Examples ![Colab](https://colab.research.google.com/assets/colab-badge.svg) ![nbviewer](https://img.shields.io/badge/render-nbviewer-orange)	20	KROSS/KMOS3D kinematics, omega distributions, cross-epoch comparisons, RAG queries
High-z Examples ![Colab](https://colab.research.google.com/assets/colab-badge.svg) ![nbviewer](https://img.shields.io/badge/render-nbviewer-orange)	25	[CII] rotation curves, ALPINE population statistics, cross-corpus omega bridge
🔬 Paper 2 Validation Track ![Colab](https://colab.research.google.com/assets/colab-badge.svg) ![nbviewer](https://img.shields.io/badge/render-nbviewer-orange)	6	Reproduce peer-reviewed results exactly from Flynn (2026), Physics of the Dark Universe: Table 2, 93% success rate, omega vs MOND, outer gap diagnostic, three-epoch arc
High-School Exploration Track ![Colab](https://colab.research.google.com/assets/colab-badge.svg) ![nbviewer](https://img.shields.io/badge/render-nbviewer-orange)	20	Friendly introductory notebooks for students: what is a rotation curve? what is a galaxy?
🚀 Quick Start
...
Flynn & Cannaliato (2025) — Omega correction introduced	Frontiers Astron Space Sci	10.3389/fspas.2025.1680387	Published
Flynn (2026) — 84 SPARC baryonic validation	Seeking journal	10.5281/zenodo.20132805	Preprint
Flynn (2026) — Unified HI Corpus v7.0 data descriptor	Astronomy & Computing	arXiv:2604.13489	Under review
Flynn (2026) — GC Corpus v1.3.1 data descriptor	PASP	arXiv:2605.03099	Submitted
Flynn (2026) — Dwarf/Irregular Corpus v1.0 data descriptor	PASP	arXiv:2605.22163	Submitted
Flynn (2026) — High-z Kinematic Corpus Z1 data descriptor	arXiv	arXiv:2605.25339	Preprint
Flynn (2026) — IntZ Kinematic Corpus v1.0 data descriptor	arXiv (astro-ph.IM)	Zenodo:20453189	Preprint
Flynn (2026) — EPS Astro Extractor v1.0.0 (software)	Zenodo	10.5281/zenodo.20486198	Preprint
...
🚀 Available Now
Tool	Description
MCP Server	Live data-serving MCP endpoint for all five corpora — dflynn5656-astro-rag-mcp.hf.space/mcp
EPS Astro Extractor	Streamlit app for extracting structured data from astronomical databases via local LLM — Zenodo
🔧 Coming Soon
Tool	Description
...
Jupyter notebooks	147 (121 research + 20 IntZ + 6 Paper 2)
MCP endpoint	Live — dflynn5656-astro-rag-mcp.hf.space/mcp
